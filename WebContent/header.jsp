...
<body>
    ...
    <header class="header text-center">	    
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="homepage?page=1">Kerem's Blog</a></h1>
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<ul class="navbar-nav flex-column text-left">
					<li class="nav-item active">
					    <a class="nav-link" href="homepage?page=1"><i class="fas fa-home fa-fw mr-2"></i>Blog Home <span class="sr-only">(current)</span></a>
					</li>
				...
				<div class="my-2 my-md-3">
				    <a class="btn btn-primary" href="https://www.junioryazilim.com" target="_blank">Get in Touch</a>
				</div>
			</div>
		</nav>
    </header>